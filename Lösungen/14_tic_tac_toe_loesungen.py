...
def check_move(move: tuple, feld: list) -> bool:  # -> {2,1}
...
def set_move(feld: list, move: tuple, zeichen: str) -> None:
    feld[move[1]][move[0]] = zeichen


def sieg_w(feld: list) -> bool:
...
def switch_player(player_now: dict, player: dict) -> dict:
